Shader "Unlit/Animal"
{
	...
	CBUFFER_END
		...
		SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
		{
			...
			Unity_TilingAndOffset_float(IN.uv0.xy, float2 (1, 1), float2 (-0.03, -0.03), _TilingAndOffset_1760631ae5f24d6aaebdec098f9b1c2e_Out_3);
			...
			Unity_TilingAndOffset_float(IN.uv0.xy, float2 (1, 1), float2 (0.03, -0.03), _TilingAndOffset_6b0644ec7c284897a4293b5eb03dee3c_Out_3);
			...
			Unity_TilingAndOffset_float(IN.uv0.xy, float2 (1, 1), float2 (-0.03, 0.03), _TilingAndOffset_3cffe83c38ab4ad4b0dddf08d0187255_Out_3);
			...
			Unity_TilingAndOffset_float(IN.uv0.xy, float2 (1, 1), float2 (0.03, 0.03), _TilingAndOffset_a8acf869a3d24e45922b92c21c8dca57_Out_3);
